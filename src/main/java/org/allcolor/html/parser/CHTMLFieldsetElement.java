 ...
 * @author Quentin Anciaux
 */
public class CHTMLFieldsetElement
    extends CHTMLElement
    implements HTMLFieldSetElement {
    static final long serialVersionUID = 1945027704357239614L;
     ...
     * @param ownerDocument
     */
    public CHTMLFieldsetElement(ADocument ownerDocument) {
     ...
     * (non-Javadoc)
     *
     * @see org.w3c.dom.html.HTMLFieldSetElement#getForm()
     */
