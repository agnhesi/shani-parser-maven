 ...
 * @author Quentin Anciaux
 */
public class CHTMLTheadElement
    extends CHTMLTableElement
    implements HTMLTableSectionElement {
    static final long serialVersionUID = 7284666443067905394L;
     ...
     * @param ownerDocument
     */
    public CHTMLTheadElement(ADocument ownerDocument) {
        super("thead", ownerDocument);
        validElement = ve;
    }
}